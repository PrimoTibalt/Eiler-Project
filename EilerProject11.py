...
def oprMax(number, maxMult):
    if(int(number) > int(maxMult)):
        return number
    else:
        return maxMult


maxMultiply("""08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
#I can do it smaller without "copy code"